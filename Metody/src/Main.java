...
public class Main {
	...
	public static void main(String[] args) {
		...
		System.out.println(obraz.obraz1(5, obraz.character1));
		System.out.println(obraz.obraz1(100, obraz.character2));
		System.out.println(obraz.obraz1(59, obraz.character3));
